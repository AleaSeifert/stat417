...
The estimated mean survival time for mini puzzle completion is 201.67 seconds. The estimated time at which 50% of the students have already completed the mini puzzle and 505 have not is 199 seconds.
...
Female students had an estimated mean survival time of 202.792 which is slightly higher than males and a median survival time of 185 seconds. Although male students had a mean survival time of 200.313 seconds, their median survival time was 229 seconds which is larger than that for females.  Non-binary had the smallest estimated mean and median completion times.
...
The 22-squares puzzle had the lowest estimated mean of 181.852 seconds and median of 172 seconds, meaning it was generally completed on the faster side..  The 19-squares puzzle had a slightly higher mean of 194.958 seconds and median of 159 second survival time, indicating it was completed slightly slower at the median level than the 22-squares puzzle. The 21-squares puzzle had a mean of 226.727 seconds, but no median could be determined, this means that 50% of participants did not complete the puzzle before the study ended at 300 seconds. The 40-squares puzzle took the longest to complete, with a mean of 235.375 seconds and a median of 288 seconds, reinforcing the possible trend that puzzles with more squares may generally require more time to finish.
...
#### **SECTION NAME (also is this the right location?)**

Comparing the nonparametric and parametric survival analyses, we observe that both approaches lead to the same general conclusions, despite differences in specific values. While the nonparametric survival times were generally lower, they also did not include values beyond 300 seconds, as the study was limited to that timeframe. However, both methods support the conclusion that the 21-squares puzzle was more time consuming, with many participants failing to complete it within the study time. The 19- and 22-squares puzzles generally took less time and the 40-squares puzzle was the most time consuming, with the highest overall mean and median completion times for both nonparametric and parametric survival analyses. Additionally, both methods agree that females and non-binary students tended to complete the puzzle faster than males, which aligns with trends observed in the survival and hazard plots.
...
We have developed many Cox regression models over the course of our analysis. 
There was insignificant evidence to conclude that at least one Beta value is not equal to 0 for Gender. Similarly, there was insignificant evidence for Squares, Reaction Time or Day, or for any combination of variables, both as main effects and interactions. 
...
Testing Proportional Hazards with `cox.zph()` returns a p-value of over .05. This indicates that our P.H. is not violated.
...
Parametric models (loglogistic) suggested a difference in mini completion times for male students as compared to female and non-binary students. The loglogistic model also identified 40 square puzzles as leading to highest probabilities of puzzle incompletion for all time.

The Kaplan-Meier analysis revealed similar relationships between completion time and auxiliary variables. We observed a notable amount of intersection between the lines for each level which likely led to the insignificance of our non-parametric models (log-rank, p > 0.05).
...
While these findings do not have immediate practical applications, they challenge intuitive assumptions about puzzle completion times across groups. Future research could explore the high variability in completion times among individuals, possibly influenced by skill level or frequency of play. A larger sample size or tracking individuals over multiple days could provide more insight into these factors.
